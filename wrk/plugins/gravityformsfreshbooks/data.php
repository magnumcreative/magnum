...
class GFFreshBooksData{
    ...
    public static function get_freshbooks_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_freshbooks";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_freshbooks_table_name());
    }
}
?>
